...
const Login = () => {
    ...
    console.log(loggedInUser, user, errors);
                                ...
                                <div className='login-form border shadow p-3 bg-body rounded'>
                                    ...
                                    <form className='' onSubmit={handleSubmit}>
                                        ...
                                        <div className="form-group">
                                            <input type="submit" value="Login" className='btn-brand text-white' />
                                        </div>
                                    </form>
                                ...
                                <div className='login-form border shadow p-3 bg-body rounded'>
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        ...
                                        <div className="from-group d-flex justify-content-center mt-4">
                                            <input type="submit" value="Create an account" className='btn-brand text-white' />
                                        </div>
                                    </form>
